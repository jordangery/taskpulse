...
export default function Home() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-10 px-6 py-12">
      ...
      <Link
        href="/members"
        className="rounded-md bg-primary px-5 py-2 text-sm font-medium text-primary-text hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-accent"
      >
        前往成員管理
      </Link>

      <p className="text-xs text-text-tertiary">Day 1 Step 8 會把這頁換成 Dashboard</p>
    </div>
  )
}
